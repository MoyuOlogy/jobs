---
name: fudanjobs
description: 复旦大学就业信息网爬虫技能。每日抓取复旦大学就业指导与生涯发展处网站的最新招聘信息，包括全职职位、实习职位、招聘信息、招聘会/宣讲会。当用户需要获取复旦大学最新招聘信息、宣讲会安排、校招职位时使用。
---

# 复旦大学就业信息网爬虫

每日抓取复旦大学就业信息网（career.fudan.edu.cn）的最新招聘数据。
